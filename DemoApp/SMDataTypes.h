...
#pragma pack(push, 1)
// for MSVS aligning works via some another directive, I think like in the next line
// __declspec(align(1)) struct TFutExec
// we need to align at 1 bute because Delphi "packed record" directive means
//it's aligned to 1 byte

// TFutExec record size in Delphi equal 76
struct TFutExec
{
